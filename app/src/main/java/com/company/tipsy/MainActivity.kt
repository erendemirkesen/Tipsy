...
class MainActivity : AppCompatActivity() {
    ...
    private fun computeTipAndTotal() {
      ...
      val tipAmount = (baseAmount * tipPercent / 100) / peopleAmount
      val totalAmount = (baseAmount / peopleAmount) + tipAmount
